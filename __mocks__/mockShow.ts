...
export const mockShow: InterfaceTvShow = {
  id: 1,
    ...
    cast: [
      ...
      },
      {
        ...
        character: {
          id: 2,
          url:
            'http://www.tvmaze.com/characters/2/under-the-dome-julia-shumway',
          name: 'Julia Shumway',
          image: {
            medium:
      ...
      },
      {
        person: {
          id: 3,
          url: 'http://www.tvmaze.com/people/3/alexander-koch',
          name: 'Alexander Koch',
          country: {
            name: 'United States',
            code: 'US',
          ...
          image: {
            medium:
              'http://static.tvmaze.com/uploads/images/medium_portrait/205/513325.jpg',
            original:
              'http://static.tvmaze.com/uploads/images/original_untouched/205/513325.jpg',
          },
          _links: {
            self: {
        ...
        character: {
          id: 3,
          url:
            'http://www.tvmaze.com/characters/3/under-the-dome-junior-rennie',
          name: 'Junior Rennie',
          image: {
            medium:
      ...
      },
      {
        ...
        character: {
          id: 5,
          url:
            'http://www.tvmaze.com/characters/5/under-the-dome-joe-mcalister',
          name: 'Joe McAlister',
          image: {
            medium:
      ...
      },
      {
        ...
        character: {
          id: 4,
          url:
            'http://www.tvmaze.com/characters/4/under-the-dome-sam-verdreaux',
          name: 'Sam Verdreaux',
          image: {
            medium:
      ...
      },
      {
        ...
        character: {
          id: 11,
          url:
            'http://www.tvmaze.com/characters/11/under-the-dome-angie-mcalister',
      ...
      },
      {
        ...
        character: {
          id: 12,
          url:
            'http://www.tvmaze.com/characters/12/under-the-dome-carolyn-hill',
          name: 'Carolyn Hill',
          image: {
            medium:
      ...
      },
      {
        ...
        character: {
          id: 13,
          url:
            'http://www.tvmaze.com/characters/13/under-the-dome-dodee-weaver',
          name: 'Dodee Weaver',
          image: {
            medium:
